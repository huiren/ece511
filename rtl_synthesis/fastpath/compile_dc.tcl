...
set my_verilog_files [list array.sv main.sv predict.sv shfreg.sv]

#/* Top-level Module                               */
set my_toplevel perceptron_bp
...
#/**************************************************/
set OSU_FREEPDK [format "%s%s"  [getenv "PDK_DIR"] "../FreePDK45/osu_soc/lib/files"]
